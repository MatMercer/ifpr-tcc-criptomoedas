...
\begin{frame}
    ...
    \begin{figure}[H]
        ...
        NVidia 1060}
        \begin{center}
            \includegraphics[width=.2\linewidth]{rig_mineracao.png}
        \end{center}
...
\begin{frame}
    ...
    \begin{figure}[H]
        ...
        \begin{center}
            \includegraphics[width=.65\linewidth]{timeline_arch.pdf}
        \end{center}
...
\begin{frame}
    ...
    \begin{figure}[H]
        ...
        \begin{center}
            \includegraphics[width=.5\linewidth]{munix-boot.png}
        \end{center}
    \end{figure}
