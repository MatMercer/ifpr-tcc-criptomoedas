...
% TODO: Trocar a referência para gazeta do povo
...
nesta etapa acaba pode tornar a mineração não lucrativa, prejudicando
...
é ``hashes por segundo'', representado por $\mathbf{h/s}$. \emph{Hardware} e
