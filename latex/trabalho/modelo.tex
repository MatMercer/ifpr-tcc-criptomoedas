...
com as Criptomoedas.
% TODO: Melhorar o histórico, colocar o ano, quem foi o criador.
...
% TODO: melhoria da citação do Ethos
...
objetivo do usuário. Atualmente, para que as Criptomoedas Etash ou
Litecoin sejam mineradas no Ubuntu, é necessário uma série de comandos
...
GPUs. As distribuições Linux atuais não oferecem suporte para detectar
o requisito mínimo de hardware para a realizar a mineração.
